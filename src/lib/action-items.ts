...
let _actionItems: ActionItem[] = [
  ...
  { id: "ai-4", title: "Trip 2026-08-0006 delayed beyond SLA", detail: "Trip 2026-08-0006 to ABC Stores is delayed beyond the service level agreement window. Client notification required.", priority: "High", category: "Delayed Trip", entity_type: "trip", entity_id: "2026-08-0006", entity_label: "Trip 2026-08-0006", due_date: daysFromNow(0), status: "open", assigned_to: "Operations Team", module: "Trips", auto_generated: true, created_at: minsAgo(5), resolved_at: null },
