...
const _comments: Map<string, DbComment[]> = new Map([
  ["trip:2026-08-0001", [
    {
      id: "c1", entity_type: "trip", entity_id: "2026-08-0001", parent_id: null,
    ...
    {
      id: "c2", entity_type: "trip", entity_id: "2026-08-0001", parent_id: null,
    ...
    {
      id: "c3", entity_type: "trip", entity_id: "2026-08-0001", parent_id: "c1",
...
const _auditEntries: DbAuditEntry[] = [
  { id: "a1", entity_type: "trip", entity_id: "2026-08-0001", entity_label: "Trip 2026-08-0001", action: "Created", field_name: null, previous_value: null, new_value: null, changed_by: "Adeleke Oladipo", changed_by_role: "Fleet Manager", module: "Trips", notes: "New trip created via Dispatch Center", created_at: hoursAgo(6) },
  { id: "a2", entity_type: "trip", entity_id: "2026-08-0001", entity_label: "Trip 2026-08-0001", action: "Status Changed", field_name: "status", previous_value: "Scheduled", new_value: "In Transit", changed_by: "Bola Adewale", changed_by_role: "Fleet Manager", module: "Trips", notes: null, created_at: hoursAgo(5) },
  ...
  { id: "a8", entity_type: "trip", entity_id: "2026-08-0003", entity_label: "Trip 2026-08-0003", action: "Status Changed", field_name: "status", previous_value: "In Transit", new_value: "Delivered", changed_by: "System", changed_by_role: "System", module: "Trips", notes: "Delivery confirmed by driver", created_at: hoursAgo(2) },
  ...
  { id: "a10", entity_type: "user", entity_id: "USR-005", entity_label: "New User Invite", action: "Created", field_name: null, previous_value: null, new_value: null, changed_by: "Adeleke Oladipo", changed_by_role: "Administrator", module: "Users", notes: "Invited kemi.ade@muvdlogistics.com as Dispatcher", created_at: hoursAgo(30) },
